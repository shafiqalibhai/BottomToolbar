...
<div class="myeditable"><b> Click here to enter an sms message </b></div>
</div>
		   ...
		   onSubmit:function submitData(content){
			   ...
			   jPrompt('Number of times to display this message:', '', '', function(r) {
					...
					$.ajax({
						type: "POST",
						url: "insert-sms.php",
						data: "message="+ content.current+"&repeat="+ r,
						success: function(){
							//$('form#submit').hide();
							//$('div.success').fadeIn();
...
<div style="border: solid thin gray; padding:5px; text-align:center;">
<div  class="myipwe"><b>Click here to enter an sms message</b> </div>
</div>
	</form>
...
$query1 = 'SELECT id, message, duration FROM smsmessages where username = "'.$session->username.'" and duration > 0';
...
echo '<br /><br />Currently displayed sms messages :<br /><table border="0" id="table1" class="tablesorter">';
echo "<thead><tr><th scope=\"col\">";
echo "id</th><th scope=\"col\">message</th><th scope=\"col\">Repeat</th><tbody>";

		...
		var sh = {
			...
			config: {
				...
				strings: {
					...
					copyToClipboardConfirmation: "Code copied to clipboard. You may now paste it in the head section of your website.",
					print: "print",
					help: "?",
					alert: "",
					noBrush: "Can't find brush for: ",
					brushNotHtmlScript: "Brush wasn't configured for html-script option: ",
					aboutDialog: "Click on the \"copy to clipboard button\" and paste this code to the head section of your website code. "
				},
				debug: false
			},
			vars: {
		...
		RegExp.prototype.exec = function (str) {
			...
			if (_117) {
				if (_105 && _117.length > 1) {
					...
					_fe.replace.call(_117[0], r2, function () {
